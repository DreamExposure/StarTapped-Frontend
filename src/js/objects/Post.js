function Post() {
    ...
    this.toJson = function () {
        let json = {
            ...
            "total_bookmarks": this.totalBookmarks,
            "total_reblogs": this.totalReblogs
        };
    ...
    this.fromJson = function (json) {
        ...
        if (json.hasOwnProperty('total_bookmarks')) {
            this.totalBookmarks = json.total_bookmarks;
        }
        if (json.hasOwnProperty('total_reblogs')) {
            this.totalReblogs = json.total_reblogs;
        }
